...
import DropdownColorPicker from '../../../lib/ui/DropdownColorPicker'
import { getSelectedNode } from '../../../lib/utils/getSelectedNode'
import { sanitizeUrl } from '../../../lib/utils/url'
import { EmbedConfigs } from '../../Youtube/AutoEmbedPlugin'
import { INSERT_COLLAPSIBLE_COMMAND } from '../../Collapsible/plugin'
import { CREAT_NEW_TABLE_DRAWER_SLUG } from '../../Table/plugin/index'
import { useModal } from '@faceless-ui/modal'
import FontSize from './fontSize'
import { INSERT_GALLERY_COMMAND } from '../../ImageGallery/plugin'
import { INSERT_LAYOUT_DRAWER_SLUG } from '../../Layout/plugin'
    ...
    <div className="toolbar">
      ...
      {blockType === 'code' ? (
        ...
        <React.Fragment>
          <FontDropDown
            disabled={!isEditable}
            // eslint-disable-next-line react/style-prop-object, react/jsx-curly-brace-presence
            style={'font-family'}
            value={fontFamily}
            editor={editor}
          />
          ...
          >
            ...
            <DropDownItem
              onClick={() => {
                activeEditor.dispatchCommand(INSERT_GALLERY_COMMAND, undefined)
              }}
              className="item"
            >
              <i className="icon gallery" />
              <span className="text">Insert gallery</span>
            </DropDownItem>
            <DropDownItem
              onClick={() => {
