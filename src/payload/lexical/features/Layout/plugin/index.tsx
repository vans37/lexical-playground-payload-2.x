...
export const INSERT_LAYOUT_DIALOG_COMMAND: LexicalCommand<boolean> = createCommand()
export const INSERT_LAYOUT_DRAWER_SLUG = 'INSERT_LAYOUT_DRAWER_SLUG'

export function LayoutPlugin(): React.ReactNode {
  ...
  return (
    <Drawer title="Insert new layout" slug={INSERT_LAYOUT_DRAWER_SLUG}>
      <InsertLayoutDialog activeEditor={editor} />
    </Drawer>
  )
}
